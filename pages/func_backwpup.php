				...
				case 'jobname':
					...
					if (empty($backupdata)) {
						...
						if (BACKWPUP_ENV_CHECK_OK)
							$actions['runnow'] = "<a href=\"" .BACKWPUP_PLUGIN_BASEURL.'/backwpup-job.php?'.$abspath.'starttype=runnow&_wpnonce='.$backwpup_cfg['jobrunauthkey'].'&jobid='.(int)$jobvalue["jobid"] . "\">" . __('Run Now','backwpup') . "</a>";
					} else {
