...
function backwpup_jobedit_metabox_destfolder($jobvalue) {
  ...
  <span class="description"><?PHP _e('A sampel Folder is:','backwpup'); echo ' '.trailingslashit( str_replace( '\\', '/', WP_CONTENT_DIR ) ) . trailingslashit( sanitize_title_with_dashes( get_bloginfo( 'name' ) ) );?></span><br />&nbsp;<br />
