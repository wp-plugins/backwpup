			...
			<form id="posts-filter" action="<?php echo backwpup_admin_url('admin.php')."?page=backwpupsettings";?>" method="post">
				...
				<table class="form-table">
					...
					<tr valign="top">
						...
						<td><input name="jobscriptretry" type="text" id="jobscriptretry" value="<?php echo backwpup_get_option('cfg','jobscriptretry');?>" class="small-text code" <?php if (defined('ALTERNATE_WP_CRON') && ALTERNATE_WP_CRON) echo " disabled=\"disabled\""; ?> />
						</td>
					</tr>
					<tr valign="top">
