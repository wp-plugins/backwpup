...
class BackWPup_Page_Metaboxes {
	...
	public function destrsc($main) {
		...
		<div class="dests">
			...
			<?php if (backwpup_get_option($main,'rscUsername') && backwpup_get_option($main,'rscAPIKey')) BackWPup_Ajax_Editjob::rsc_container(array('rscUsername'=>backwpup_get_option($main,'rscUsername'),'rscAPIKey'=>backwpup_get_option($main,'rscAPIKey'),'rscselected'=>backwpup_get_option($main,'rscContainer'))); ?>
	...
	public function destsugarsync($main) {
		...
		<div class="dests">
			...
			<?php if (backwpup_get_option($main,'sugaruser') && backwpup_get_option($main,'sugarpass')) BackWPup_Ajax_Editjob::sugarsync_root(array('sugaruser'=>backwpup_get_option($main,'sugaruser'),'sugarpass'=>backwpup_decrypt(backwpup_get_option($main,'sugarpass')),'sugarrootselected'=>backwpup_get_option($main,'sugarroot'))); ?><br />
			<b><?php _e('Folder:','backwpup'); ?></b><br />
