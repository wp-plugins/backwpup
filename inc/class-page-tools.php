...
class BackWPup_Page_Tools {
	...
	public static function css() {
		wp_enqueue_style( 'backwpup_tools', plugins_url( '', dirname( __FILE__ ) ) . '/css/tools.css', '', ((defined( 'SCRIPT_DEBUG' ) && SCRIPT_DEBUG) ? time() : BackWPup::get_plugin_data('Version')), 'screen' );
	}
	...
	<div class="wrap">
		...
		<form id="posts-filter" enctype="multipart/form-data" action="<?php echo backwpup_admin_url( 'admin.php' ) . '?page=backwpuptools'; ?>" method="post">
			...
			<table class="form-table">
				<tr valign="top">
					<th scope="row"><label for="importfile"><?php _e( 'Select file to import:', 'backwpup' ); ?></label>
					</th>
